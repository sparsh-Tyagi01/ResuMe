  ...
  return (
    <div className="flex flex-col justify-center items-center gap-4 w-full min-h-screen bg-slate-100">
      ...
      <div className="w-[35vw] flex flex-col items-center gap-3 bg-white py-6 rounded-2xl shadow-xl mb-10">
        ...
        <form onSubmit={handleSubmit} className="w-[30vw] text-black/70 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-[30vw] focus:outline-none border-2 border-black/20 p-1 rounded-[10px] mt-2"
            />
          </div>
          <div>
          ...
          <button type="submit" className="w-[30vw] mt-2 bg-gradient-to-r from-green-700 to-emerald-600 rounded-[5px] text-white py-1 hover:from-green-800 hover:to-emerald-700 transition-all duration-200 cursor-pointer">
            Log In
          </button>
        </form>
        ...
        <h2 className="text-black/70">
          ...
          <span onClick={()=> navigate("/register")} className="text-blue-600 font-medium cursor-default">
            Sign up
          </span>
        </h2>
      </div>
